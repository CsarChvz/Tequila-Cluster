 ...
 * per stage is enforced separately by {@code StagePermissionService} (RB-504), not by this
 * filter chain, since permissions depend on data in role_stage_permission, not just the role.
 */
@Configuration
@EnableWebSecurity
